            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                {...register("NombreContrato", {
                  required: { 
                    value: true, 
                    message: "Nombre del contrato es requerido" 
                  },
                  minLength: {
                    value: 5,
                ...
                autoFocus
                className={
                  "form-control " + (errors?.NombreContrato ? "is-invalid" : "")
                }
              />
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                className={
                  "form-control " + (errors?.ImporteMensual ? "is-invalid" : "")
                }
              />
              <div className="invalid-feedback">
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                className={
                  "form-control " + (errors?.TelefonoContacto ? "is-invalid" : "")
                }
              />
              <div className="invalid-feedback">
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                className={
                  "form-control " + (errors?.FechaFin ? "is-invalid" : "")
                }
              />
              <div className="invalid-feedback">
